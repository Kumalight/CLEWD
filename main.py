...
def parse_args():
    ...
    parser.add_argument('--cfg-path', type=str, default= 'configs/robust_adversarial.json', help='config path')
    # parser.add_argument('--cfg-path', type=str, default='configs/rsns30_10.json', help='config path')
...
if __name__ == '__main__':
    ...
    print('time implementation cost',time2-time1)